...
//                     httpRequest(
//                         url: "https://trantien100700.atlassian.net/rest/api/2/issue/${jiraIssueKey}/transitions",
//                         httpMode: 'POST',
//                         customHeaders: [
...
//                     httpRequest(
//                         url: "https://trantien100700.atlassian.net/rest/api/2/issue/${jiraIssueKey}/attachments",
//                         httpMode: 'POST',
//                         customHeaders: [
//                             [name: 'Authorization', value: jiraAuth],
...
//                     )
                    ...
                    """
                     bat """
                        ...
                        -F "file=@${attachment}" \
                        https://trantien100700.atlassian.net/rest/api/2/issue/${jiraIssueKey}/attachments
                    """
                }
            }
        }
